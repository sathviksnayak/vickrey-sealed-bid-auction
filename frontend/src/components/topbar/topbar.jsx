...
import { Menu, Wallet, ChevronDown, Copy, RefreshCw, LogOut } from "lucide-react";
import { useState, useRef, useEffect } from "react";
import "./topbar.css";
import { useWallet } from "../../context/WalletContext";

export default function Topbar({ sidebarOpen, setSidebarOpen }) {
    const { account, connectWallet, switchAccount, disconnectWallet } = useWallet();
                ...
                <div className="wallet-menu-wrapper" ref={menuRef}>
                    ...
                    {menuOpen && (
                        <div className="wallet-dropdown">
                            ...
                            <button className="wallet-dropdown-item" onClick={handleSwitchAccount}>
